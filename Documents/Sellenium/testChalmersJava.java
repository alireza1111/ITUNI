...
public class TestChalmersJava {
  ...
  @Test
  public void testChalmersJava() throws Exception {
		driver.get(baseUrl + "/sv/Sidor/default.aspx");
		driver.findElement(By.id("ctl00_ctl43_ctl00_SearchButton")).click();
		driver.findElement(By.cssSelector("#ctl00_ctl43_ctl00_SearchButton")).click();
		...
		try {
			assertEquals("Praktikant vid Chalmers verksamhetsstöd/IT-avdelningen/IT-utveckling", driver.findElement(By.cssSelector("div.person-details > p")).getText());
		} catch (Error e) {
