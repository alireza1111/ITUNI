...
{ 
    ...
    static // just a static method that does some of the initialization, the static ones
    {
        ...
        String urlPath = PACKAGE_NAME + IMAGE_PATH + "Legal.png";
        //using the .net.URL as a resource locator via the classloader
        java.net.URL imageURL = CLSLDR.getResource("/img/");
        BACK_IMAGE = new ImageIcon("/img/Legal.png");
    ...
    public Card(Face face, Suit suit) {
        ...
        String cardFilename = "" + faceChar + suitChar + ".png";
