...
/**
 * Nyhetssida - Nyhet i Centralt nyhetsarkiv - Skapa utan  huvudbild- Tagga globalt, institiotion och syrkeområde
 * 
 * @author alidav
 *
 */
public class ID1115 {
  ...
  @Test
  public void testID1115() throws Exception {
...
//Click Webbplatsåtgärder
		...
		tag.click();
		tag.sendKeys("Global; Styrkeomrade; Institution; ");
		WebElement tid;
		...
		driver.findElement(By.id("checkincomments")).sendKeys("test 11.1.5");
