  ...
  public void testId1331() throws Exception {
		...
		if (driver instanceof JavascriptExecutor) {
			((JavascriptExecutor)driver).executeScript(""
					...
					+ "tBox.setAttribute('value','Testcase 13.5.2');"
		...
		if (driver instanceof JavascriptExecutor){
			((JavascriptExecutor)driver).executeScript(""
					...
					+ "txtIngress.textContent= '​Det är bara JavaScript testScript till testID13.5';"
					+ "");
		}
		//visa element på
		...
		driver.findElement(By.id("checkincomments")).sendKeys("test 13.5.1");
