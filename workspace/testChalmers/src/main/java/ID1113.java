...
/**
 * Nyhetssida - Nyhet i Centralt nyhetsarkiv - Skapa utan  huvudbild- Tagga globalt och institution
 * 
 * @author alidav
 *
 */
public class ID1113 {
  ...
  @Test
  public void testID1113() throws Exception {
...
//Click Webbplatsåtgärder
		...
		tag.click();
		tag.sendKeys("Global; Institution; ");
		WebElement tid;
