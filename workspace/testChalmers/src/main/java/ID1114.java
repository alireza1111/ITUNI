...
/**
 * Nyhetssida - Nyhet i Centralt nyhetsarkiv - Skapa utan  huvudbild- Tagga globalt och syrkeområde
 * 
 * @author alidav
 *
 */
public class ID1114 {
  ...
  @Test
  public void testID1114() throws Exception {
...
//Click Webbplatsåtgärder
		...
		tag.click();
		tag.sendKeys("Global; Styrkeomrade; ");
		WebElement tid;
		...
		driver.findElement(By.id("checkincomments")).sendKeys("test 11.1.4");
