...
/**
 * Kalendersida - Händelse i Centrala Kalendariet - Skapa - Tagga globalt och styrkeområde
 * @author alidav
 *
 */
...
public class ID135 {
	...
	@Test
	public void testId135() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='ctl00_PlaceHolderMain_ctl01_ctl01_ctl02editableRegion']")).sendKeys("Global; Styrkeomrade; ");
		//plats
		...
		driver.findElement(By.id("checkincomments")).sendKeys("test 13.5");
