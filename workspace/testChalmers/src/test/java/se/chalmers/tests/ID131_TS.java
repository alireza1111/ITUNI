...
/**
 * Kalendersida - H√§ndelse i Centrala Kalendariet - Skapa med dagens datum
 * S‰tt TimeStamp fˆr att h‰ntera olika testscript namn.
 * @author alidav
 *
 */

public class ID131_TS {
	...
	public void testId131() throws Exception {
		...
		FlerHandelser= wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Fler h‰ndelser")));  //Explicit wait
		FlerHandelser.click();

		//Click Webbplats√•tg√§rder
		WebElement WPatg;
		WebElement t=null;
		...
		tBox.sendKeys("Testcase 13.1_"+instant.toEpochMilli());
		...
		txtIngress.sendKeys("‚ÄãNeque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...");
		//plats
		...
		//startDatum
		Thread.sleep(3000);
		driver.findElement(By.id("ctl00_PlaceHolderMain_ctl01_ctl04_StartDate_ctl00_DateTimeField_DateTimeFieldDate")).sendKeys("2017-03-07");
		//slutDatun
		driver.findElement(By.id("ctl00_PlaceHolderMain_ctl01_ctl04_EndDate_ctl00_DateTimeField_DateTimeFieldDate")).sendKeys("2017-03-07");
		...
		driver.findElement(By.id("checkincomments")).sendKeys("test 13.1");
